...
G_TYPED_KERNEL(GPredictPoints,
               ...
               "ai.retro.predictPoints"){
    static cv::GArrayDesc outMeta(cv::GArrayDesc in){return cv::empty_array_desc();
}
}
;

/*!
 * \brief Predict the results of an optical flow calculation given the previous
 * points
 *
 ...
 * @param predPts Points containing the predicted new positions of input
